...
(() => {
  ...
  var init_react_shim = __esm({
    "react-shim.js"() {
      ...
      ReactDOM = __toESM(require_client(), 1);
      window.React = React;
  ...
  function App() {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "min-h-screen bg-gradient-to-br from-gray-900 to-black text-gray-100", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { className: "fixed w-full bg-black/80 backdrop-blur-md z-50", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "container mx-auto px-4 py-4 flex justify-between items-center", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center space-x-2", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-xl font-bold", children: "Valtio Storybook Binding" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", { className: "hidden md:flex space-x-8", children: ["Features", "Installation", "Examples", "Documentation"].map(
            (item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "a",
              {
        ...
        mobileMenuOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "md:hidden bg-gray-900/90 backdrop-blur-md py-4 px-4 space-y-3", children: ["Features", "Installation", "Examples", "Documentation"].map(
          (item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "a",
            {
              href: `#${item.toLowerCase()}`,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", { className: "pt-32 pb-20 px-4 container mx-auto", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "max-w-4xl mx-auto text-center", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { className: "text-4xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 to-blue-500", children: "Seamless Storybook & Valtio Integration" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-xl md:text-2xl text-gray-300 mb-10 leading-relaxed", children: "Create dynamic component previews with two-way state binding between Storybook and Valtio stores" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex flex-col sm:flex-row gap-4 justify-center", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "a",
            {
              href: "#installation",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mt-16", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "img",
          {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", { id: "features", className: "py-20 px-4 bg-gray-900/50", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "container mx-auto max-w-6xl", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { className: "text-3xl font-bold text-center mb-12", children: "Key Features" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "grid md:grid-cols-3 gap-8", children: [
          {
            title: "Two-Way Binding",
            description: "Synchronize Storybook args with Valtio stores in real-time for seamless state management",
          ...
          },
          {
            ...
            description: "Minimal overhead with optimized state updates and efficient decorator system",
            icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "svg",
              {
                className: "w-6 h-6 text-emerald-500",
          ...
          },
          {
            ...
            description: "Customizable decorators and utilities for advanced use cases and extensions",
            icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "svg",
              {
                className: "w-6 h-6 text-emerald-500",
        ...
        ].map((feature, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "div",
          {
            "data-scroll": true,
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-start space-x-4", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mt-1", children: feature.icon }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "text-xl font-semibold mb-2", children: feature.title }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-gray-400", children: feature.description })
              ] })
            ] })
          },
          index
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", { id: "installation", className: "py-20 px-4", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "container mx-auto max-w-4xl", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { className: "text-3xl font-bold text-center mb-12", children: "Installation" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-700 shadow-xl", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mb-4 flex items-center", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-emerald-400 mr-2", children: "$" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-gray-400", children: "npm install storybook-valtio-binding valtio" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "border-t border-gray-700 my-4" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", { className: "text-sm overflow-x-auto", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", { className: "text-gray-300", children: `// .storybook/preview.tsx
...
export const decorators = [...ValtioStorybookTwoWayBindingDecorators];` }) })
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", { id: "examples", className: "py-20 px-4 bg-gray-900/50", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "container mx-auto max-w-4xl", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { className: "text-3xl font-bold text-center mb-12", children: "Usage Example" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-700 shadow-xl", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", { className: "text-sm overflow-x-auto", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", { className: "text-gray-300", children: `import { proxy } from 'valtio';
...
export const Counter = withStores(
  ...
  (args) => (
    ...
    >
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", { className: "py-20 px-4", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "container mx-auto max-w-5xl", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "grid md:grid-cols-2 gap-12 items-center", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { className: "text-3xl font-bold mb-6", children: "Why Choose This Integration?" }),
          ...
          ].map((benefit, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { className: "flex items-start", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "svg",
              {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "relative", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute -bottom-6 -right-6 w-32 h-32 bg-emerald-500/20 rounded-full blur-2xl" })
        ] })
      ] }) }) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", { className: "py-20 px-4 bg-gradient-to-r from-emerald-900/30 to-blue-900/30", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "container mx-auto max-w-3xl text-center", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { className: "text-3xl font-bold mb-6", children: "Ready to Streamline Your Development?" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-xl text-gray-300 mb-8", children: "Start using the Storybook-Valtio integration today and revolutionize your component development workflow." }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", { className: "py-10 px-4 border-t border-gray-800", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "container mx-auto max-w-5xl", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex flex-col md:flex-row justify-between items-center", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center space-x-2 mb-6 md:mb-0", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "svg",
            {
              className: "w-6 h-6 text-emerald-500",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-lg font-semibold", children: "Valtio Storybook Binding" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "text-sm text-gray-500", children: [
          "\xA9 ",
          (/* @__PURE__ */ new Date()).getFullYear(),
          " Valtio Storybook Binding. MIT Licensed."
        ] })
      ] }) }) })
    ] });
  }
